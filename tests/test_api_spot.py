...
def test_post_batch_orders():
    ...
    assert (
        spotAPI.post_batch_orders(symbol="BTC_USDT", order_params=order_params)[0][
            "code"
        ]
        == 1000
    )
...
def test_post_cancel_order_by_orderid():
    ...
    assert (
        spotAPI.post_cancel_order_by_orderid(symbol="BTC_USDT", order_id="2147617164")[
            0
        ]["code"]
        == 1000
    )
...
def test_post_cancel_order_by_clientid():
    """Test POST https://api-cloud.bitmart.com/spot/v3/cancel_order"""
    assert (
        spotAPI.post_cancel_order_by_clientid(
            symbol="BTC_USDT", client_order_id="ID125783"
        )[0]["code"]
        == 1000
    )
...
def test_post_cancel_orders():
    ...
    assert (
        spotAPI.post_cancel_orders(
            symbol="BTC_USDT", order_ids=["sdfdsf4343", "sdfdsa123"]
        )[0]["code"]
        == 1000
    )
...
def test_v4_query_order_by_id():
    ...
    assert (
        spotAPI.v4_query_order_by_id(order_id="118100034543076010", query_state="open")[
            0
        ]["code"]
        == 1000
    )
...
def test_v4_query_order_by_order_client_id():
    ...
    assert (
        spotAPI.v4_query_order_by_order_client_id(
...
def test_v4_query_order_trade_list():
    ...
    assert (
        spotAPI.v4_query_order_trade_list(order_id="118100034543076010")[0]["code"]
        == 1000
    )


def test_v4_algo_submit_order():
    """Test POST https://api-cloud.bitmart.com/spot/v4/algo/submit_order"""
    assert (
        spotAPI.v4_algo_submit_order(
            symbol="BTC_USDT",
            side="buy",
            type="trigger",
            client_order_id="myAlgoOrder001",
            extra_params={
                "price": "20000",
                "size": "0.01",
                "trigger_type": "limit",
...
def test_v4_algo_cancel_order():
    """Test POST https://api-cloud.bitmart.com/spot/v4/algo/cancel_order"""
    assert (
        spotAPI.v4_algo_cancel_order(
            symbol="BTC_USDT", order_id="12312312313123", type="trigger"
        )[0]["code"]
        == 1000
    )


def test_v4_algo_cancel_all():
    """Test POST https://api-cloud.bitmart.com/spot/v4/algo/cancel_all"""
    assert spotAPI.v4_algo_cancel_all(type="trigger")[0]["code"] == 1000
    assert (
        spotAPI.v4_algo_cancel_all(type="trigger", symbol="BTC_USDT")[0]["code"] == 1000
    )


def test_v4_query_algo_order_by_id():
    """Test POST https://api-cloud.bitmart.com/spot/v4/query/algo/order"""
    assert (
        spotAPI.v4_query_algo_order_by_id(
...
def test_v4_query_algo_order_by_client_id():
    """Test POST https://api-cloud.bitmart.com/spot/v4/query/algo/client-order"""
    assert (
        spotAPI.v4_query_algo_order_by_client_id(
            client_order_id="myAlgoOrder001", query_state="open"
        )[0]["code"]
        == 1000
    )


def test_v4_query_algo_open_orders():
    """Test POST https://api-cloud.bitmart.com/spot/v4/query/algo/open-orders"""
    assert spotAPI.v4_query_algo_open_orders()[0]["code"] == 1000
    assert (
        spotAPI.v4_query_algo_open_orders(symbol="BTC_USDT", order_mode="trigger")[0][
            "code"
        ]
        == 1000
    )
...
def test_v4_query_algo_history_orders():
    """Test POST https://api-cloud.bitmart.com/spot/v4/query/algo/history-orders"""
    assert spotAPI.v4_query_algo_history_orders()[0]["code"] == 1000
    assert (
        spotAPI.v4_query_algo_history_orders(symbol="BTC_USDT", order_mode="trigger")[
            0
        ]["code"]
        == 1000
    )
