...
def test_get_mark_price_kline():
    ...
    start_time = end_time - 3600
    assert (
        contractAPI.get_mark_price_kline(
            contract_symbol="ETHUSDT", step=5, start_time=start_time, end_time=end_time
        )[0]["code"]
        == 1000
    )
...
def test_get_fund_rate_history():
    ...
    assert (
        contractAPI.get_fund_rate_history(contract_symbol="ETHUSDT", limit=10)[0][
            "code"
        ]
        == 1000
    )
...
def test_get_trade_fee_rate():
    ...
    assert contractAPI.get_trade_fee_rate(contract_symbol="BTCUSDT")[0]["code"] == 1000


def test_get_assets_detail():
    """Test GET https://api-cloud-v2.bitmart.com/contract/private/assets-detail"""
    assert contractAPI.get_assets_detail()[0]["code"] == 1000


def test_get_order():
    """Test GET https://api-cloud-v2.bitmart.com/contract/private/order"""
    assert (
        contractAPI.get_order(contract_symbol="BTCUSDT", order_id="220609666322019")[0][
            "code"
        ]
        == 1000
    )
    ...
    assert (
        contractAPI.get_order(
            contract_symbol="BTCUSDT", order_id="220609666322019", account="futures"
        )[0]["code"]
        == 1000
    )
...
def test_get_order_history():
    ...
    assert (
        contractAPI.get_order_history(
            contract_symbol="BTCUSDT", start_time=before, end_time=after
        )[0]["code"]
        == 1000
    )
...
def test_get_current_plan_order():
    ...
    assert contractAPI.get_current_plan_order()[0]["code"] == 1000

    assert (
        contractAPI.get_current_plan_order(contract_symbol="BTCUSDT")[0]["code"] == 1000
    )


def test_get_position():
    """Test GET https://api-cloud-v2.bitmart.com/contract/private/position"""
    assert contractAPI.get_position(contract_symbol="BTCUSDT")[0]["code"] == 1000

    assert (
        contractAPI.get_position(contract_symbol="BTCUSDT", account="futures")[0][
            "code"
        ]
        == 1000
    )
...
def test_get_position_risk():
    ...
    assert contractAPI.get_position_risk(contract_symbol="BTCUSDT")[0]["code"] == 1000

    assert (
        contractAPI.get_position_risk(contract_symbol="BTCUSDT", account="futures")[0][
            "code"
        ]
        == 1000
    )
...
def test_get_transaction_history():
    ...
    trades = contractAPI.get_transaction_history(
        contract_symbol="BTCUSDT", start_time=1662368173, end_time=1662368179
    )
    assert trades[0]["code"] == 1000
...
def test_post_modify_limit_order():
    ...
    response = contractAPI.post_modify_limit_order(
...
def test_post_cancel_order():
    ...
    assert (
        contractAPI.post_cancel_order(
            contract_symbol="ETHUSDT", order_id="220906179559421"
        )[0]["code"]
        == 1000
    )

    assert contractAPI.post_cancel_order(contract_symbol="ETHUSDT")[0]["code"] == 1000
...
def test_post_cancel_orders():
    ...
    assert contractAPI.post_cancel_orders(contract_symbol="ETHUSDT")[0]["code"] == 1000


def test_post_submit_plan_order():
    """Test POST https://api-cloud-v2.bitmart.com/contract/private/submit-plan-order"""
    assert (
        contractAPI.post_submit_plan_order(
            contract_symbol="BTCUSDT",
            type="limit",
            side=4,
            leverage="1",
...
def test_post_cancel_plan_order():
    ...
    assert (
        contractAPI.post_cancel_plan_order(contract_symbol="BTCUSDT")[0]["code"] == 1000
    )

    assert (
        contractAPI.post_cancel_plan_order(
            contract_symbol="BTCUSDT", order_id="230602272118231"
        )[0]["code"]
        == 1000
    )
    ...
    assert (
        contractAPI.post_cancel_plan_order(
            contract_symbol="BTCUSDT", client_order_id="230602272118231"
        )[0]["code"]
        == 1000
    )
...
def test_post_transfer():
    ...
    assert (
        contractAPI.post_transfer(
            currency="USDT", amount="10", type="spot_to_contract"
        )[0]["code"]
        == 1000
    )
...
def test_post_submit_leverage():
    ...
    assert (
        contractAPI.post_submit_leverage(
...
def test_post_submit_trail_order():
    ...
    response = contractAPI.post_submit_trail_order(
        contract_symbol="BTCUSDT",
        side=4,
        leverage="20",
        open_type="cross",
...
def test_post_cancel_trail_order():
    ...
    assert (
        contractAPI.post_cancel_trail_order(contract_symbol="ETHUSDT")[0]["code"]
        == 1000
    )
...
def test_post_cancel_all_after():
    ...
    assert (
        contractAPI.post_cancel_all_after(contract_symbol="BTCUSDT", timeout=120)[0][
            "code"
        ]
        == 1000
    )
...
def test_post_set_position_mode():
    ...
    assert (
        contractAPI.post_set_position_mode(position_mode="one_way_mode")[0]["code"]
        == 1000
    )
...
def test_get_position_v2():
    ...
    assert (
        contractAPI.get_position_v2(contract_symbol="BTCUSDT", account="futures")[0][
            "code"
        ]
        == 1000
    )
...
def test_get_leverage_bracket():
    ...
    assert (
        contractAPI.get_leverage_bracket(contract_symbol="BTCUSDT")[0]["code"] == 1000
    )
...
def test_get_market_trade():
    ...
    assert (
        contractAPI.get_market_trade(contract_symbol="BTCUSDT", limit=1)[0]["code"]
        == 1000
    )


def test_get_funding_rate_v2():
    """Test GET https://api-cloud-v2.bitmart.com/contract/public/funding-rate-v2"""
    assert contractAPI.get_funding_rate_v2()[0]["code"] == 1000
    assert contractAPI.get_funding_rate_v2(contract_symbol="BTCUSDT")[0]["code"] == 1000


def test_post_claim():
    """Test POST https://api-cloud-v2.bitmart.com/contract/private/claim"""
    assert contractAPI.post_claim()[0]["code"] == 1000


def test_get_auto_repayment():
    """Test GET https://api-cloud-v2.bitmart.com/contract/private/auto_repayment"""
    assert contractAPI.get_auto_repayment()[0]["code"] == 1000
    assert (
        contractAPI.get_auto_repayment(
...
def test_get_cross_collateral_interest_log():
    """Test GET https://api-cloud-v2.bitmart.com/contract/private/cross_collateral/interest_log"""
    assert contractAPI.get_cross_collateral_interest_log()[0]["code"] == 1000
    assert (
        contractAPI.get_cross_collateral_interest_log(
            start_time=1770739200,
            end_time=1771257600,
            page=1,
            size=20,
...
def test_get_affiliate_aff_customer_info():
    """Test GET https://api-cloud-v2.bitmart.com/contract/private/affiliate/aff-customer-info"""
    assert (
        contractAPI.get_affiliate_aff_customer_info(user_id=123456)[0]["code"] == 1000
    )


def test_get_affiliate_deposit_withdrawal_list():
    """Test GET https://api-cloud-v2.bitmart.com/contract/private/affiliate/deposit-withdrawal-list"""
    assert (
        contractAPI.get_affiliate_deposit_withdrawal_list(
            page=1,
            size=50,
            cid=123456,
            start_time=1770739200,
...
def test_get_affiliate_rebate_invite_user():
    """Test GET https://api-cloud-v2.bitmart.com/contract/private/affiliate/rebate-inviteUser"""
    assert (
        contractAPI.get_affiliate_rebate_invite_user(
            start_time=1770739200, end_time=1771257600, page=1, size=50, cid=123456
        )[0]["code"]
        == 1000
    )


def test_get_affiliate_invite_check():
    """Test GET https://api-cloud-v2.bitmart.com/contract/private/affiliate/invite-check"""
    assert contractAPI.get_affiliate_invite_check(cid=123456)[0]["code"] == 1000


def test_get_affiliate_rebate_user():
    """Test GET https://api-cloud-v2.bitmart.com/contract/private/affiliate/rebate-user"""
    assert (
        contractAPI.get_affiliate_rebate_user(
            cid=123456, start_time=1770739200, end_time=1771257600
        )[0]["code"]
        == 1000
    )


def test_get_affiliate_rebate_api():
    """Test GET https://api-cloud-v2.bitmart.com/contract/private/affiliate/rebate-api"""
    assert (
        contractAPI.get_affiliate_rebate_api(
            cid=123456, start_time=1770739200, end_time=1771257600
        )[0]["code"]
        == 1000
    )
...
def test_get_affiliate_rebate_list():
    """Test GET https://api-cloud-v2.bitmart.com/contract/private/affiliate/rebate-list"""
    assert (
        contractAPI.get_affiliate_rebate_list(
            page=1,
            size=50,
            currency="USDT",
            user_id=123456,
...
def test_get_affiliate_trade_list():
    """Test GET https://api-cloud-v2.bitmart.com/contract/private/affiliate/trade-list"""
    assert (
        contractAPI.get_affiliate_trade_list(
            user_id=123456,
            type=1,
            page=1,
            size=50,
