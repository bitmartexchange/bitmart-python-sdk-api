...
my_client.subscribe(args="futures/klineBin1m:BTCUSDT")

time.sleep(2)

# Unsubscribe
my_client.unsubscribe(args="futures/klineBin1m:BTCUSDT")

time.sleep(5)
# Example 2:
# Send the original subscription message
my_client.send({"action": "subscribe", "args": ["futures/klineBin1m:BTCUSDT"]})

time.sleep(2)

# Unsubscribe
my_client.send({"action": "unsubscribe", "args": ["futures/klineBin1m:BTCUSDT"]})
